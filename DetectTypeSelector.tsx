  ...
  return (
    <div className="flex flex-col flex-shrink-0">
      ...
      <div className="flex flex-col gap-3">
        {['2D bounding boxes', 'Segmentation masks', 'Points', 'Price prediction', 'Text extraction'].map((label) => (
...
function SelectOption({label}: {label: string}) {
  ...
  return (
    <button
      className={`py-4 px-4 items-center bg-transparent text-center gap-2`}
      style={{
