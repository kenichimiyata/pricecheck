...
export const defaultPromptParts = {
  ...
  'Price prediction': [
    'Detect the',
    'items',
    ', estimate their current market price in Japanese Yen (JPY), and output as a JSON list. Each entry must have "box_2d", "label", and "price" (a string with the price and currency symbol like "¥1,000").',
  ],
  'Text extraction': [
    'Detect and extract all visible',
    'text',
    ' from the image. Output a JSON list where each entry contains "box_2d" for the text location and "label" for the transcribed text content.',
  ],
};
...
export const defaultPrompts = {
  ...
  'Price prediction': defaultPromptParts['Price prediction'].join(' '),
  'Text extraction': defaultPromptParts['Text extraction'].join(' '),
};
